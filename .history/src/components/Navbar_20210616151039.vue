<template>
  <nav>
    <v-app-bar app color="#F5F7F9" dense>
      <!-- <v-app-bar-nav-icon
        dark
        small
        @click="drawer = !drawer"
        class="black--text "
      ></v-app-bar-nav-icon> -->
      <v-text-field prepend-inner-icon="mdi-magnify" hide-details  color="#F5F7F9" class="text-input-blue" placeholder="Search here for sura">
    ...
    <v-navigation-drawer v-model="drawer" app mini-variant color="#F5F7F9">
