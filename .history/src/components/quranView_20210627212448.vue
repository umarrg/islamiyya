        ...
        <v-card-text class="pa-10">
          ...
          <v-row>
            <v-col class="px-0">
              ...
              <div v-for="i in hausaTran" :key="i">
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log(response.data.verses.verse_key);
      })
      .catch((e) => console.log(e));

    axios
      .get(
        ` https://api.quran.com/api/v4/quran/translations/32?chapter_number=${this.id}&verse_key=1:2`
      )
      .then((res) => {
