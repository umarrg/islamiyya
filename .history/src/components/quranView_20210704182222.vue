              ...
              <div>
                <span class="primary--text"
                  >English Sahih Ibnu-Khasir |<v-btn
                    ...
                    @click="getTranslations(), translation = !translation"
                    >see tafseer
                    <v-icon color="" small>mdi-arrow-right</v-icon>
                  </v-btn></span
                >
              </div>
              <div v-for="(item, key) in hausaTran" :key="key"  v-show="translation">
                {{ key }}. {{ item.text }}
              </div>
              <div class="mt-5">
                <v-divider></v-divider>
  ...
  methods: {
    ...
    getTranslations() {
      ...
      axios
        ...
        .finally(() => (this.loading = false) (this.translation = true) );
    },
  },
