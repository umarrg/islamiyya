        ...
        <v-card-text class="pa-10">
          ...
          <v-row>
            <v-col class="px-0">
              ...
              <div v-for="(item, index) in hausaTran" :key="index">
...
export default {
  ...
  methods: {
    like() {
      ...
      //   text_uthmani: this.sample.text_uthmani,
      //   verse_key: this.sample.verse_key,
      // });
      // this.sample.text_uthmani = "";
      // this.sample.verse_key = "";
      var data = {
        verse_key: this.surahs.verse_key,
        id: this.surahs.id,
        text_uthmani: this.surahs.text_uthmani,
      };
      // this.sample.id = "";
