          ...
          >
            <v-list dense>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>
                    <span>{{ item.surahs.englishName }}</span>
                  </v-list-item-title>
                  <v-list-item-subtitle>
                    <span>{{ item.surahs.englishNameTranslation }}</span>
                  </v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
            </v-list>
...
export default {
  ...
  mounted() {
    axios
      .get("http://api.alquran.cloud/v1/quran/quran-uthmani" + this.id)
      .then((response) => {
