...
export default new Vuex.Store({
  ...
  actions: {
    ...
    fetchLikes({ commit }, userId) {
      return fetch(`https://ancient-meadow-78729.herokuapp.com/api/v1/like/${userId}`, {
        method: "get",
        headers: {
    ...
    createLike({ commit }, likeData) {
      const data = {
        verse_key: likeData.verse_key,
        verse_number: likeData.verse_number,
      ...
      fetch("https://ancient-meadow-78729.herokuapp.com/api/v1/like/", {
        ...
        .then((response) => {
          if (response.status === "failed") {
            ...
            commit("postComment", response.payload);
          }
        })
